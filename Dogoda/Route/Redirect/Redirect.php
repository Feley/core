...
namespace Dogoda\Route\Redirect;

use Dogoda\Enums\FormValidationEnum;
use Dogoda\Flash\Flash;
use Dogoda\Flash\FlashError;
use Dogoda\Flash\HtmlFormValuesStorage;
use Dogoda\Http\Request;
use Dogoda\Http\Url;

/**
 * Class Redirect
 * @package Dogoda\Route\Redirect
 */
class Redirect
{
    /**
