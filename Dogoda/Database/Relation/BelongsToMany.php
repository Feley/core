...
namespace Dogoda\Database\Relation;

use Dogoda\Collection\Collection;
use Dogoda\Database\BuilderQuery;
use Dogoda\Database\Custom\Db;
use Dogoda\Database\Model;
use App\Interfaces\RelationInterface;

/**
 * Class BelongsToMany
 * @package Dogoda\Database\Relation
 * @mixin BuilderQuery
 */
